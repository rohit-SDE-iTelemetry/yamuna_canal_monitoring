...
logging.basicConfig(filename='/home/nayan/yamuna_canal dev/project source code/git/yamuna_canal_monitoring/yamuna_canal_monitoring/logs/raw-file-generater.log', filemode='a', format=FORMAT)
